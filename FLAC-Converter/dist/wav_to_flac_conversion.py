...
# Sets the limit as 18 TB then convert that to bits
...
def compare_and_copy(source, drive_folder, csv_file): # In the case your run gets cancelled mid copy, this will search
    ...
    for root, dirs, files in os.walk(source):
        dirs[:] = [d for d in dirs if not d.startswith('.') and d.lower() != 'system volume information' and d.lower() != '$RECYCLE.BIN']
